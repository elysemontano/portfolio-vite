  ...
  return (
    <div className="w-full h-screen bg-parallax overflow-hidden relative">
      ...
      <div className="pt-15 max-w-screen-lg mx-auto h-full flex flex-col justify-center lg:items-start items-center text-white relative z-10 lg:px-8">
        <h1 className="sm:text-4xl text-2xl text-white font-Rubik font-extrabold tracking-widest pt-20 md:hover-animate max-xs:text-center">
          Hello, I'm Elyse Montano
        </h1>
        <h2 className="xs:text-lg max-xs:text-center text-md text-white tracking-widest  md:hover-animate">
          A full stack{" "}
        ...
        <div className="md:flex items-center md:px-8">
          <div className="md:hover-animate pr-14 max-md:hidden">
            <img
              src={ProfilePic}
          ...
          <div className="max-md:px-8 max-md:text-center md:hover-animate max-sm:text-sm">
