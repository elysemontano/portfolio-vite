...
const Footer = () => {
  return (
    <div id="contact" className="max-w-[1040px] m-auto p-4 py-16 text-gray-500 lg:hover-animate">
      ...
      <p className="pt-4 pb-2 flex">
        Feel free to reach out for more information, check out my{' '}
        <a href="https://github.com/elysemontano" target="_blank" className=" hover:animate-pulse flex text-indigo-900">
          <AiFillGithub className="mx-2 cursor-pointer " size={25} />
          GitHub
        </a>
        , or connect with me on{' '}
        <a href="https://www.linkedin.com/in/elysemontano/" target="_blank" className="text-indigo-900 flex hover:animate-pulse">
          <AiFillLinkedin className="mx-2 cursor-pointer" size={25} />
          LinkedIn
        </a>
        !
      </p>
